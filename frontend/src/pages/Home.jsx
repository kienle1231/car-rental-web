            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/10 border border-white/20 rounded-2xl px-4 py-3 flex items-center gap-3">
                  ...
                  <select className="bg-transparent w-full text-sm text-white focus:outline-none">
                    <option className="text-black" value="">Car type</option>
                    <option className="text-black" value="luxury">Luxury</option>
                    <option className="text-black" value="sport">Sport</option>
                    <option className="text-black" value="suv">SUV</option>
                    <option className="text-black" value="electric">Electric</option>
                  </select>
                </div>
                <motion.button whileHover={{ scale: 1.02 }} className="w-full bg-gradient-to-r from-yellow-400 to-amber-500 text-black py-3 rounded-2xl font-bold shadow-lg shadow-yellow-500/30">
                  Search Cars
                </motion.button>
              </div>
            </motion.form>
          ...
          <div className="bg-white/10 border border-white/20 rounded-full shadow-2xl shadow-black/50 backdrop-blur-2xl px-4 py-4 md:px-6 w-full max-w-6xl">
            <div className="grid grid-cols-1 md:grid-cols-[1.4fr_1fr_1fr_1fr_auto] gap-3 items-center">
              <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-full px-4 py-3">
                ...
                <input className="bg-transparent text-sm text-white placeholder:text-gray-400 w-full focus:outline-none" placeholder="Where to pick up?" />
              </div>
              <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-full px-4 py-3">
                <Calendar className="w-4 h-4 text-yellow-400" />
                <input className="bg-transparent text-sm text-white placeholder:text-gray-400 w-full focus:outline-none" placeholder="Start date" />
              </div>
              <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-full px-4 py-3">
                <Calendar className="w-4 h-4 text-yellow-400" />
                <input className="bg-transparent text-sm text-white placeholder:text-gray-400 w-full focus:outline-none" placeholder="End date" />
              </div>
              <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-full px-4 py-3">
                <Car className="w-4 h-4 text-yellow-400" />
                <input className="bg-transparent text-sm text-white placeholder:text-gray-400 w-full focus:outline-none" placeholder="Car type" />
              </div>
              <motion.button whileHover={{ scale: 1.03 }} className="bg-gradient-to-r from-yellow-400 to-amber-500 text-black px-6 py-3 rounded-full font-bold shadow-lg shadow-yellow-500/30">
                Search
              </motion.button>
            </div>
          </div>
